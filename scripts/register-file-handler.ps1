...
function New-IconJson {
    ...
    @{
        svg = "$normalizedBaseUrl/assets/$AssetPrefix-$IconType.svg"
        png1x = "$normalizedBaseUrl/assets/$AssetPrefix-$IconType-32.png"
        "png1.5x" = "$normalizedBaseUrl/assets/$AssetPrefix-$IconType-48.png"
        png2x = "$normalizedBaseUrl/assets/$AssetPrefix-$IconType-64.png"
